...
from app.models.analysis import AnalysisResponse, RoomMetrics
from app.models.geometry import Room
from app.services.spatial.cache import LRUCache
from app.services.spatial.circulation import build_corridors, build_entries, interior_anchor
from app.services.spatial.core import RoomAnalysis, ZoneData
from app.services.spatial.geometry_utils import dot, pieces_of, poly_pts
from app.services.spatial.hashing import room_hash
from app.services.spatial.keepout import build_keepout, keep_clear_union
from app.services.spatial.normalize import require_valid_room
from app.services.spatial.walls import build_walls, longest_clear_wall_index
