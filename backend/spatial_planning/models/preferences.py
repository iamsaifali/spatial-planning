...
from spatial_planning.models.products import RoomType, StyleTag
...
class Preferences(StrictModel):
    ...
    # --- room-type aware fields (all optional, additive) ------
    # room_type selects the planner recipe (living_room default, or bedroom); seating_capacity
    # is the living-room seat-count target (Q1).
