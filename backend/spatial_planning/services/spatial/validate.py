...
from spatial_planning.models.products import CATEGORY_LABELS, Product, placement_group
...
from spatial_planning.services.spatial.core import CorridorData, RoomAnalysis
