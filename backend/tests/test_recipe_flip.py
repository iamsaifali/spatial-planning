...
GOLDEN_LIVING_RECIPE = "lay_0dff965858"  # recipe (Phase 2: GAP-driven accent chairs) - production; a 2nd flanking chair now tops up toward the seat target (was 1 area-scaled chair)
